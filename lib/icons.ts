...
// Rendered via components/Icon.astro. Stroke icons unless noted.
export const icons: Record<string, string> = {
  code: '<polyline points="16 18 22 12 16 6"></polyline><polyline points="8 6 2 12 8 18"></polyline>',
  braces:
    '<path d="M8 3H7a2 2 0 0 0-2 2v5a2 2 0 0 1-2 2 2 2 0 0 1 2 2v5a2 2 0 0 0 2 2h1"></path><path d="M16 3h1a2 2 0 0 1 2 2v5a2 2 0 0 0 2 2 2 2 0 0 0-2 2v5a2 2 0 0 1-2 2h-1"></path>',
  atom:
    '<circle cx="12" cy="12" r="1"></circle><path d="M20.2 20.2c2.04-2.03.02-7.36-4.5-11.9-4.54-4.52-9.87-6.54-11.9-4.5-2.04 2.03-.02 7.36 4.5 11.9 4.54 4.52 9.87 6.54 11.9 4.5Z"></path><path d="M15.7 15.7c4.52-4.54 6.54-9.87 4.5-11.9-2.03-2.04-7.36-.02-11.9 4.5-4.52 4.54-6.54 9.87-4.5 11.9 2.03 2.04 7.36.02 11.9-4.5Z"></path>',
  rocket:
  ...
  cpu:
    '<rect width="16" height="16" x="4" y="4" rx="2"></rect><rect width="6" height="6" x="9" y="9" rx="1"></rect><path d="M15 2v2M15 20v2M2 15h2M2 9h2M20 15h2M20 9h2M9 2v2M9 20v2"></path>',
  ...
  briefcase:
    '<rect width="20" height="14" x="2" y="7" rx="2"></rect><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"></path>',
  ...
  calendar: '<rect width="18" height="18" x="3" y="4" rx="2"></rect><path d="M3 10h18M8 2v4M16 2v4"></path>',
  user: '<circle cx="12" cy="8" r="5"></circle><path d="M20 21a8 8 0 0 0-16 0"></path>',
};

type ProjectLike = { industry?: string; service?: string; tech?: string[] };

// Pick a representative icon for a project based on its industry/service/tech.
export function projectIcon(p: ProjectLike): string {
  const hay = [p.industry, p.service, ...(p.tech ?? [])].join(' ').toLowerCase();
  if (/(e-?commerce|store|shop|retail|apparel|fashion)/.test(hay)) return 'cart';
  if (/(news|media|portal|magazine|press|berita)/.test(hay)) return 'newspaper';
  if (/(seo|search)/.test(hay)) return 'search';
  if (/(ai|saas|software|platform|app|dashboard|system|tool)/.test(hay)) return 'cpu';
  return 'globe';
}
