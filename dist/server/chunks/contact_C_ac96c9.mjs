...
Ready to start a project? I'm available for freelance work and collaborations ✦
  ...
  })} </div> </div> </section> ${renderComponent($$result2, "Footer", Footer, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/home/malaka/Documents/rafiq/components/Footer", "client:component-export": "default" })} </main> ` })}`;
}, "/home/malaka/Documents/rafiq/src/pages/contact.astro", void 0);
const $$file = "/home/malaka/Documents/rafiq/src/pages/contact.astro";
const $$url = "/contact";
