...
function niche(slug, category, categoryName, title, description, hero, problem, features, usp, testimonials, faq) {
...
const NICHE_MAP = new Map(
  NICHES.map((n) => [n.slug, n])
);
const NICHE_SLUGS = NICHES.map((n) => n.slug);
export {
  NICHE_SLUGS as N,
  NICHE_MAP as a
};
