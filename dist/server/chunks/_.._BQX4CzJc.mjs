...
import { $ as $$NicheLandingPage, C as CircleCheck } from "./NicheLandingPage_CisrX6p4.mjs";
import { a as TARGET_CITIES_98, A as ALLOWED_SERVICES, T as TARGET_CITIES, S as SEO_SERVICES } from "./constants_CXIdmYgm.mjs";
import { N as NICHE_SLUGS, a as NICHE_MAP } from "./niches_CDM8Av3T.mjs";
...
const $$ = createComponent(($$result, $$props, $$slots) => {
  ...
  if (resolvedService.startsWith("jasa-website-")) {
    ...
    for (const nicheSlug of sortedSlugs) {
      if (remainder.startsWith(nicheSlug + "-")) {
        ...
        if (TARGET_CITIES_98.includes(citySlug)) {
  ...
  if (locationArray.length > 0) {
    ...
    const allCities = [.../* @__PURE__ */ new Set([...TARGET_CITIES, ...TARGET_CITIES_98])].sort((a, b) => b.length - a.length);
