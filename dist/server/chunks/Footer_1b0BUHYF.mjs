...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "nav",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 flex items-center justify-between h-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--accent)" }, children: "R" }),
                "afiq",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "var(--accent)" }, children: "." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "hidden md:flex items-center gap-1", children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: item.path,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/contact", className: "btn-kirim hidden md:inline-flex", style: { padding: "0.5rem 1.25rem", fontSize: "0.8125rem", textDecoration: "none" }, children: "Let's Talk ✦" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-6 py-4 flex flex-col gap-2", children: [
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "footer",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 py-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center md:items-start gap-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", style: { color: "var(--text-secondary)" }, children: "Building polished web experiences ✦" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-3", children: [
            { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Github, { size: 18 }), href: "https://github.com/raakanaka", label: "GitHub" },
            { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Linkedin, { size: 18 }), href: "https://linkedin.com/in/rafiq-alhafizh", label: "LinkedIn" },
            { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 18 }), href: "mailto:rafiq.adha@rafiq.biz.id", label: "Email" }
