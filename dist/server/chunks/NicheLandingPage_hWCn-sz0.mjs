...
const $$NicheLandingPage = createComponent(($$result, $$props, $$slots) => {
  ...
  const isEcommerceUmkm = n.slug === "ecommerce-umkm";
  const offers = isEcommerceUmkm ? [
    { badge: "UMKM Retail", name: "Paket Basic UMKM", price: "3500000", priceCurrency: "IDR", display: "Rp3,5 Juta", features: ["Desain E-commerce Responsif", "Domain & Hosting (1 Tahun)", "SEO On-Page Dasar", "Bandwidth Unmetered", "Integrasi Payment Gateway", "Katalog Produk Dasar"] },
    { badge: "Toko Grosir & Distributor", name: "Paket Advanced UMKM", price: "5500000", priceCurrency: "IDR", display: "Rp5,5 Juta", isPopular: true, features: ["Semua Fitur Paket Basic", "Setup Google Merchant Shopping", "Email Bisnis Profesional", "Setup Schema Markup / AI Overview", "Katalog Produk Lanjut", "Integrasi Kurir Otomatis"] },
    { badge: "Corporate & Enterprise", name: "Paket Custom Enterprise", price: "0", priceCurrency: "IDR", display: "Custom", features: ["Semua Fitur Paket Advanced", "Custom Web Application", "Integrasi ERP / Sistem Kasir", "Dukungan Optimasi Struktur Kode", "Fitur Bilingual", "Dedicated Support"] }
  ] : [
    { badge: "UMKM / Personal", name: "Paket Starter", price: "1600000", priceCurrency: "IDR", display: "Rp1,6 Juta", features: ["Custom Tema Responsif", "Domain & Hosting (1 Tahun)", "SEO On-Page Dasar", "Bandwidth Unmetered", "Integrasi Tombol WhatsApp", "Maks. 5 Halaman Dasar"] },
    { badge: "Perusahaan / CV", name: "Paket Pro", price: "2200000", priceCurrency: "IDR", display: "Rp2,2 Juta", isPopular: true, features: ["Semua Fitur Paket Starter", "Desain Halaman Khusus Premium", "Email Bisnis Profesional", "Setup Schema Markup / AI Overview", "Maks. 10 Halaman", "Gratis Setup Google My Business"] },
    { badge: "Corporate VIP", name: "Paket Premium", price: "2900000", priceCurrency: "IDR", display: "Rp2,9 Juta", features: ["Semua Fitur Paket Pro", "Server Hosting Premium", "Katalog Produk Lanjut/LMS", "Fitur Bilingual (Dua Bahasa)", "Analisis Konversi", "Revisi Minor Selama Masa Aktif"] }
  ];
  const jsonLd = {
